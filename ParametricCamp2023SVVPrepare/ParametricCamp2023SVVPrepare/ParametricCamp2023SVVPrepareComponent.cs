...
{
    public class ParametricCamp2023SVVPrepareComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public ParametricCamp2023SVVPrepareComponent()
          : base("FirstScript", "fs",
            "Our first script",
            "SVV", "Primitive")
        {
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("45ae8a47-4e82-4d8d-b288-5534bb0eecdf");
    }
}